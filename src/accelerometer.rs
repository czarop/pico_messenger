...
// pub async fn accelrometer_task(
//     int_pin: Peri<'static, PIN_15>,
//     i2c_driver: embassy_embedded_hal::shared_bus::asynch::i2c::I2cDevice<
//         'static,
//         CriticalSectionRawMutex,
...
//     accel
//         .write_reg(lis2dw12_i2c::Register::WakeUpThreshold, 0x02)
//         .await
//         .expect("failed to set wake-up threshold");
//     accel
//         .write_reg(lis2dw12_i2c::Register::Control7, 0x20)
//         .await
//         .expect("failed to enable interrupts");
//     // Route wake-up interrupt to INT1 pin
//     accel
//         .write_reg(lis2dw12_i2c::Register::Control4Interrupt1, 0x20)
//         .await
//         .expect("failed to set wake-up interrupt");
//     accel
//         .write_reg(lis2dw12_i2c::Register::WakeUpDuration, 0x10)
//         .await
//         .expect("failed to set wake-up duration");
//     let mut int1 = embassy_rp::gpio::Input::new(int_pin, embassy_rp::gpio::Pull::Down);

//     loop {
//         // real code
//         // let dormant = int1.dormant_wake(embassy_rp::gpio::DormantWakeConfig {
//         //     edge_high: true,
//         //     edge_low: false,
//         //     level_high: false,
//         //     level_low: false,
